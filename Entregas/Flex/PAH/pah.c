...
int main(int argc, const char *argv[])
{
    ...
    if(argc < 2){   // Nenhum argumento = ERRO
        ...
        if( strcmp(argv[1],"--latex")==0 || strcmp(argv[1],"--html")==0){ // É opçao = ERRO
            ...
            input=1;
            outputFileLatex = open("Latex.tex",O_WRONLY|O_CREAT|O_TRUNC,0644);
            outputFileHtml = open("Html.html",O_WRONLY|O_CREAT|O_TRUNC,0644);
         ...
         if( strcmp(argv[1],"--latex")==0 ){  // Abre argumento e gera Latex
            ...
            outputFileLatex = open(auxl,O_WRONLY|O_CREAT|O_TRUNC,0644);
            outputFileHtml = open(auxh,O_WRONLY|O_CREAT|O_TRUNC,0644);
         ...
         if( strcmp(argv[1],"--latex")==0 ){ // Abre argumento e gera Latex
            ...
            inputFile = open(argv[2],O_RDONLY);
            input=2;
            outputFileLatex = open(argv[3],O_WRONLY|O_CREAT|O_TRUNC,0644);
             ...
             inputFile = open(argv[2],O_RDONLY);
             input=2; 
             outputFileHtml = open(argv[3],O_WRONLY|O_CREAT|O_TRUNC,0644);
            ...
            outputFileLatex = open(argv[2],O_WRONLY|O_CREAT|O_TRUNC,0644);
            outputFileHtml = open(argv[3],O_WRONLY|O_CREAT|O_TRUNC,0644);
    ...
    if(output<2){
        ...
        if(!pidLatex){
            ...
            execlp("pah_latex","pah_latex",NULL);
            exit(0);
        }
    }
    wait(0);
